                                ...
                                @else
                                    <li class="item">
                                        <div class="hover-parent">
                                            ...
                                            <div class="hover-content">
                                                <p><b>Welcome</b></p>
                                                <p class="text-muted">To access account and manage orders</p>
                                                <a class="btn btn-primary mt-2" href="#" data-bs-toggle="modal" data-bs-target="#login">Login / Signup</a>
