                                            ...
                                            @else
                                                @if(ucfirst($status) == 'Delivered')
                                                    <div class="delivery-tick">                                                        
                                                        ...
                                                        <svg fill="#ffffff" width="13px" height="13px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M760 380.4l-61.6-61.6-263.2 263.1-109.6-109.5L264 534l171.2 171.2L760 380.4z"/></svg>
                                                    </div>
                                                @endif
