    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('sub2-categories.create') }}" class="btn btn-primary">New Sub2 Category</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @if ($sub2Categories->isNotEmpty())
                            @foreach ($sub2Categories as $subCategory)
                                <tr>
                                    <td>{{ $subCategory->id }}</td>
                                    <td>{{ $subCategory->name }}</td>
                                    <td>{{ $subCategory->categoryName }} ({{ $subCategory->subCategoryName }})</td>                                    
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('sub2-categories.edit', $subCategory->id ) }}">
