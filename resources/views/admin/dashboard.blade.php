                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-2">
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark"></span>Categories</p>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-2">
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark"></span>Products</p>
                            {{-- <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark">500 </span>GB</p> --}}
                        </div>
                    </div> 
                </div> 
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-2">
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark">22</span>Orders</p>
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark">234</span>Pending</p>
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark">123 </span>Done</p>                            
                        </div>
                    </div> 
                </div> 
            </div> 
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-2">
                            <p class="text-muted mb-0 fs-13 fw-semibold"><span class="text-dark">₹222 </span>Total Revenue</p>
                        </div>
                    </div> 
                </div> 
            </div>                                                                               
