            ...
            <div class="row align-items-center">
                <div class="row">
                    <div class="col-sm-7 col-12 d-flex">
                        <h3>Users</h3>  
                        <span class="counts">{{ $users->total() }}</span>
                    </div>
                    <div class="col-sm-5 col-12 float-end">
                        <div class="flexContainer">
                            ...
                            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#createUserModal">Create User</button>                            
                        </div>
                    </div>
                </div>                        
            </div>
